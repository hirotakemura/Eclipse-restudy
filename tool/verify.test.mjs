...
const mustDetect = [
  ...
  /**
   * ★**mm で書いた公差**（D-466 で見つけた穴）。以前は `μm・ミクロン・ミリ` しか見ておらず、
   * 「±0.01mm」の形で書かれた作った公差が warn に落ちて**止まらなかった**。
   * 照合の前に `±` は `+` に置き換わるので、そちらで一致させている。
   */
  ["答えてもらえなかった精度を、mm で書く",
   "当社は薄肉部品で±0.003mmの精度に対応しています。", "fabricated-tolerance"],
];
...
const mustPass = [
  ...
  ["データにある型番", "マシニングセンタ（ブラザー工業 S700X1）を6台保有しています。"],
  ["データにある認証", "ISO9001を取得しています。"],
  ["データにある創業年", "1972年の創業以来、精密切削加工を手がけてきました。"],
  ["データにある納期とロット", "1個から対応し、標準納期は7日、お急ぎの場合は最短3日です。"],
  /** **± の無い mm は大きさ。** 公差として止めない（出典のない大きさは warn で人が見る） */
  ["データにある肉厚（± の無い mm）", "肉厚が2mmを切る薄い部品にも対応しています。"],
  ["取材で得た強み（数値なし）",
